        ...
        {data &&
          data.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="grid grid-cols-1 md:grid-cols-5 gap-4  p-4 rounded-2xl transition-colors"
              >
                {iconRequired && (
                ...
                <div
                  className={`${iconRequired ? "md:col-span-4" : "md:col-span-5"} w-full space-y-3 px-0 md:px-3 pb-5 pt-2`}
                >
                  <a
                    href={iconRequired && (item.link ?? "#")}
                    target="_blank"
                  ...
                  <div className="text-white/70 text-sm py-3 rounded-lg">
